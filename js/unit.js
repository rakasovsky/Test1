...
style.from(".lineg",{duration:1, opacity:0, x:-500, stagger:0.8},"-=0.6")
...
const reversedChars = 
pos.from(".pos1g",{duration:2, opacity:0, x:-500})
pos.from(".pre3g",{duration:2, opacity:0, x:-500})
pos.from(".rec3g",{duration:2, opacity:0, x:500})
pos.from(".icons2",{duration:1, opacity:0, x:200, stagger:{each: -0.4}})
...
off.from(".lampg",{duration:2, opacity:0, y:-500})
off.from(".lightg",{duration:2, opacity:0, ease: "yoyo", repeat:1})
off.from(".pre5g",{duration:2, opacity:0, x:-500})
...
we.from(".we_rect",{duration:2, opacity:0, x:-500})
we.from(".we_cush",{duration:2, opacity:0, x:-500},"-=2")
